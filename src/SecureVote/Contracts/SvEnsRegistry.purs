...
module SecureVote.Contracts.SvEnsRegistry where
...
import Network.Ethereum.Web3.Solidity (BytesN, D2, D3, D4, D6, DOne, Tuple0(..), Tuple1(..), Tuple2(..), Tuple3(..), UIntN, class IndexedEvent, unTuple1)
