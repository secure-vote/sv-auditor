...
dInit :: forall e. TransactionOptions NoPay -> { democName :: String } -> Web3 e HexString
dInit x0 r = uncurryFields  r $ dInit' x0
   where
    dInit' :: TransactionOptions NoPay -> Tagged (SProxy "democName") String -> Web3 e HexString
