...
approve x0 r = uncurryFields  r $ approve' x0
   where
    approve' :: TransactionOptions NoPay -> Tagged (SProxy "_spender") Address -> Tagged (SProxy "_value") (UIntN (D2 :& D5 :& DOne D6)) -> Web3 e HexString
...
transferFrom x0 r = uncurryFields  r $ transferFrom' x0
   where
    transferFrom' :: TransactionOptions NoPay -> Tagged (SProxy "_from") Address -> Tagged (SProxy "_to") Address -> Tagged (SProxy "_value") (UIntN (D2 :& D5 :& DOne D6)) -> Web3 e HexString
...
transfer x0 r = uncurryFields  r $ transfer' x0
   where
    transfer' :: TransactionOptions NoPay -> Tagged (SProxy "_to") Address -> Tagged (SProxy "_value") (UIntN (D2 :& D5 :& DOne D6)) -> Web3 e HexString
