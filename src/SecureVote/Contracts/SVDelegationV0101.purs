...
import Network.Ethereum.Web3.Solidity (D2, D4, D5, D6, DOne, Tuple0(..), Tuple1(..), Tuple2(..), Tuple3, Tuple6, UIntN, class IndexedEvent, unTuple1)
...
type GetHistoricalDelegationFn = Tagged (SProxy "getHistoricalDelegation(uint64)") (Tuple1 (UIntN (D6 :& DOne D4)))

getHistoricalDelegation :: forall e. TransactionOptions NoPay -> ChainCursor -> { delegationId :: (UIntN (D6 :& DOne D4)) } -> Web3 e (Either CallError (Tuple6 (UIntN (D6 :& DOne D4)) (UIntN (D6 :& DOne D4)) (UIntN (D6 :& DOne D4)) Address Address Address))
getHistoricalDelegation x0 cm r = uncurryFields  r $ getHistoricalDelegation' x0 cm
   where
    getHistoricalDelegation' :: TransactionOptions NoPay -> ChainCursor -> Tagged (SProxy "delegationId") (UIntN (D6 :& DOne D4)) -> Web3 e (Either CallError (Tuple6 (UIntN (D6 :& DOne D4)) (UIntN (D6 :& DOne D4)) (UIntN (D6 :& DOne D4)) Address Address Address))
...
_rawGetTokenDelegation :: forall e. TransactionOptions NoPay -> ChainCursor -> { _voter :: Address, _tokenContract :: Address } -> Web3 e (Either CallError (Tuple6 (UIntN (D6 :& DOne D4)) (UIntN (D6 :& DOne D4)) (UIntN (D6 :& DOne D4)) Address Address Address))
_rawGetTokenDelegation x0 cm r = uncurryFields  r $ _rawGetTokenDelegation' x0 cm
   where
    _rawGetTokenDelegation' :: TransactionOptions NoPay -> ChainCursor -> Tagged (SProxy "_voter") Address -> Tagged (SProxy "_tokenContract") Address -> Web3 e (Either CallError (Tuple6 (UIntN (D6 :& DOne D4)) (UIntN (D6 :& DOne D4)) (UIntN (D6 :& DOne D4)) Address Address Address))
...
resolveDelegation :: forall e. TransactionOptions NoPay -> ChainCursor -> { voter :: Address, tokenContract :: Address } -> Web3 e (Either CallError (Tuple6 (UIntN (D6 :& DOne D4)) (UIntN (D6 :& DOne D4)) (UIntN (D6 :& DOne D4)) Address Address Address))
resolveDelegation x0 cm r = uncurryFields  r $ resolveDelegation' x0 cm
   where
    resolveDelegation' :: TransactionOptions NoPay -> ChainCursor -> Tagged (SProxy "voter") Address -> Tagged (SProxy "tokenContract") Address -> Web3 e (Either CallError (Tuple6 (UIntN (D6 :& DOne D4)) (UIntN (D6 :& DOne D4)) (UIntN (D6 :& DOne D4)) Address Address Address))
...
getDelegationID :: forall e. TransactionOptions NoPay -> ChainCursor -> { voter :: Address, tokenContract :: Address } -> Web3 e (Either CallError (UIntN (D6 :& DOne D4)))
getDelegationID x0 cm r = uncurryFields  r $ getDelegationID' x0 cm
   where
    getDelegationID' :: TransactionOptions NoPay -> ChainCursor -> Tagged (SProxy "voter") Address -> Tagged (SProxy "tokenContract") Address -> Web3 e (Either CallError (UIntN (D6 :& DOne D4)))
...
--------------------------------------------------------------------------------
-- | FnT_getLogTokenContractFn
--------------------------------------------------------------------------------


type FnT_getLogTokenContractFn = Tagged (SProxy "_getLogTokenContract(uint256)") (Tuple1 (UIntN (D2 :& D5 :& DOne D6)))

_getLogTokenContract :: forall e. TransactionOptions NoPay -> ChainCursor -> { i :: (UIntN (D2 :& D5 :& DOne D6)) } -> Web3 e (Either CallError Address)
_getLogTokenContract x0 cm r = uncurryFields  r $ _getLogTokenContract' x0 cm
   where
    _getLogTokenContract' :: TransactionOptions NoPay -> ChainCursor -> Tagged (SProxy "i") (UIntN (D2 :& D5 :& DOne D6)) -> Web3 e (Either CallError Address)
    _getLogTokenContract' y0 cm' y2 = map unTuple1 <$> call y0 cm' ((tagged $ Tuple1 (untagged y2 )) :: FnT_getLogTokenContractFn)
...
_rawGetGlobalDelegation :: forall e. TransactionOptions NoPay -> ChainCursor -> { _voter :: Address } -> Web3 e (Either CallError (Tuple6 (UIntN (D6 :& DOne D4)) (UIntN (D6 :& DOne D4)) (UIntN (D6 :& DOne D4)) Address Address Address))
_rawGetGlobalDelegation x0 cm r = uncurryFields  r $ _rawGetGlobalDelegation' x0 cm
   where
    _rawGetGlobalDelegation' :: TransactionOptions NoPay -> ChainCursor -> Tagged (SProxy "_voter") Address -> Web3 e (Either CallError (Tuple6 (UIntN (D6 :& DOne D4)) (UIntN (D6 :& DOne D4)) (UIntN (D6 :& DOne D4)) Address Address Address))
...
constructor :: forall e. TransactionOptions NoPay -> HexString -> { prevDelegationSC :: Address } -> Web3 e HexString
constructor x0 bc r = uncurryFields  r $ constructor' x0 bc
   where
    constructor' :: TransactionOptions NoPay -> HexString -> Tagged (SProxy "prevDelegationSC") Address -> Web3 e HexString
