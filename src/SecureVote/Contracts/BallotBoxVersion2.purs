...
module SecureVote.Contracts.BallotBoxVersion2 where
...
import Network.Ethereum.Web3.Solidity (BytesN, D2, D3, D4, D5, D6, DOne, Tuple0(..), Tuple1(..), Tuple2(..), Tuple3(..), Tuple4, UIntN, class IndexedEvent, unTuple1)
...
voterToBallotID :: forall e. TransactionOptions NoPay -> ChainCursor -> Address -> Web3 e (Either CallError (UIntN (D2 :& D5 :& DOne D6)))
...
ballotMap :: forall e. TransactionOptions NoPay -> ChainCursor -> (UIntN (D2 :& D5 :& DOne D6)) -> Web3 e (Either CallError (Tuple3 (BytesN (D3 :& DOne D2)) Address (UIntN (D3 :& DOne D2))))
...
type AssociatedPubkeysFn = Tagged (SProxy "associatedPubkeys(uint256)") (Tuple1 (UIntN (D2 :& D5 :& DOne D6)))

associatedPubkeys :: forall e. TransactionOptions NoPay -> ChainCursor -> (UIntN (D2 :& D5 :& DOne D6)) -> Web3 e (Either CallError (BytesN (D3 :& DOne D2)))
...
submitBallotWithPk :: forall e. TransactionOptions NoPay -> { encryptedBallot :: (BytesN (D3 :& DOne D2)), senderPubkey :: (BytesN (D3 :& DOne D2)) } -> Web3 e HexString
submitBallotWithPk x0 r = uncurryFields  r $ submitBallotWithPk' x0
   where
    submitBallotWithPk' :: TransactionOptions NoPay -> Tagged (SProxy "encryptedBallot") (BytesN (D3 :& DOne D2)) -> Tagged (SProxy "senderPubkey") (BytesN (D3 :& DOne D2)) -> Web3 e HexString
...
type ConstructorFn = Tagged (SProxy "constructor(bytes32,uint64[2],bool[2])") (Tuple3 (BytesN (D3 :& DOne D2)) (Vector (DOne D2) (UIntN (D6 :& DOne D4))) (Vector (DOne D2) Boolean))

constructor :: forall e. TransactionOptions NoPay -> HexString -> { _specHash :: (BytesN (D3 :& DOne D2)), openPeriod :: (Vector (DOne D2) (UIntN (D6 :& DOne D4))), flags :: (Vector (DOne D2) Boolean) } -> Web3 e HexString
constructor x0 bc r = uncurryFields  r $ constructor' x0 bc
   where
    constructor' :: TransactionOptions NoPay -> HexString -> Tagged (SProxy "_specHash") (BytesN (D3 :& DOne D2)) -> Tagged (SProxy "openPeriod") (Vector (DOne D2) (UIntN (D6 :& DOne D4))) -> Tagged (SProxy "flags") (Vector (DOne D2) Boolean) -> Web3 e HexString
...
newtype CreatedBallot = CreatedBallot {_creator :: Address,_openPeriod :: (Vector (DOne D2) (UIntN (D6 :& DOne D4))),_useEncryption :: Boolean,_specHash :: (BytesN (D3 :& DOne D2))}
...
instance indexedEventCreatedBallot :: IndexedEvent (Tuple0 ) (Tuple4 (Tagged (SProxy "_creator") Address) (Tagged (SProxy "_openPeriod") (Vector (DOne D2) (UIntN (D6 :& DOne D4)))) (Tagged (SProxy "_useEncryption") Boolean) (Tagged (SProxy "_specHash") (BytesN (D3 :& DOne D2)))) CreatedBallot where
  isAnonymous _ = false
...
newtype SuccessfulPkVote = SuccessfulPkVote {voter :: Address,ballot :: (BytesN (D3 :& DOne D2)),pubkey :: (BytesN (D3 :& DOne D2))}
...
instance indexedEventSuccessfulPkVote :: IndexedEvent (Tuple0 ) (Tuple3 (Tagged (SProxy "voter") Address) (Tagged (SProxy "ballot") (BytesN (D3 :& DOne D2))) (Tagged (SProxy "pubkey") (BytesN (D3 :& DOne D2)))) SuccessfulPkVote where
  isAnonymous _ = false
...
newtype SuccessfulVote = SuccessfulVote {voter :: Address,ballot :: (BytesN (D3 :& DOne D2))}
...
instance indexedEventSuccessfulVote :: IndexedEvent (Tuple0 ) (Tuple2 (Tagged (SProxy "voter") Address) (Tagged (SProxy "ballot") (BytesN (D3 :& DOne D2)))) SuccessfulVote where
  isAnonymous _ = false
